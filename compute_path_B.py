"""
compute_path_B.py  —  Path planner for Robot B
================================================
Computes the full waypoint path and saves it to path_B.csv.
Run this file to regenerate the path after changing config.

CSV columns:  step, x, y, type, pole
  - type: "start", "move", or "wrap"
  - pole: which pole this waypoint relates to (0 = none)
"""

import math, csv, os

# ==================================================================
# WORLD CONFIGURATION  (shared — keep identical in compute_path_A.py)
# ==================================================================
...
def save_csv(pts, filename="path_B.csv"):
    """Write waypoints to CSV for debugging / inspection."""
...
# ==================================================================
# MAIN — run directly to regenerate path_B.csv
# ==================================================================
...
if __name__ == "__main__":
    ...
    print(f"Robot {RID} | start={START} seq={SEQ} dir={DIR} circles={CIRCLES}")
    print(f"  {len(pts)} waypoints, {total:.1f} cm total distance")
    print(f"  Saved → {path}")